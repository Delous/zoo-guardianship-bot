...
QUESTIONS: list[dict[str, Any]] = [
    {
        ...
        "answers": [
            ...
            {"id": "q1_e", "text": "Открывает один глаз и проверяет происходящее вокруг. Думает.", "scores": {"eagle_owl": 1}},
        ],
    },
    {
        "id": 2,
        ...
        "answers": [
            ...
            {"id": "q2_c", "text": "Я сначала посмотрю, что лежит в присланном файле “Финал_точно_последний_версия_3”", "scores": {"raccoon": 1}},
            {"id": "q2_d", "text": "Займусь подготовкой презентации, чтобы комнада выглядела прилично на защите.", "scores": {"flamingo": 1}},
            {"id": "q2_e", "text": "Молча наблюдает за происходящим и делает выводы.", "scores": {"eagle_owl": 1}},
        ],
    },
    {
        "id": 3,
        ...
        "answers": [
            ...
            {"id": "q3_d", "text": "Прогулка, красивое место, фото, кофе, все для ощущения: я персонаж романтического фильма.", "scores": {"flamingo": 1}},
            {"id": "q3_e", "text": "Книга, чай, тишина и возможность не объяснять, почему это лучший план.", "scores": {"eagle_owl": 1}},
        ],
    },
    {
        "id": 4,
